...
// Funcion para implementar, los clientes y con modificacions para hacer paginación 
...
// Eliminar cliente y se le aplica en el historial para poder tener un control 
...
// Funcion para modificar el elemento "a" para que ponga Clientes(x)
